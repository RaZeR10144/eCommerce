...
import eCommerce.CloudMobiles.service.CartService;
...
public class CartController 
{
	...
	public ModelAndView showCart(@RequestParam(name = "result", required = false) String result)
	{
		...
		if(result != null)
		{
			...
			case "updated":
				...
				break;
			case "added":
				mv.addObject("message", "Product has been successfully added!");
				break;
			case "deleted":
	...
	public String udateCart(@PathVariable int cartLineId)
	{
