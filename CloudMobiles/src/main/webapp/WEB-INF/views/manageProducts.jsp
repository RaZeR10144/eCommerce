			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<sf:form id="categoryForm" modelAttribute="category" action="${contextRoot}/manage/category" method="POST" class="form-horizontal">
						<div class="form-group">
							<label for="category_name" class="control-form col-md-4">Category Name</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							<label for="category_decription" class="control-form col-md-4">Category Description</label>
							<div class="col-md-8">
